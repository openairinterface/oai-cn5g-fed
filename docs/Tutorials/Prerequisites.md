# OpenAirInterface 5G Core Network Docker Deployment : Pre-Requisites
...
*  You can pull official images from Docker Hub like [this](Retrieve-Official-Images.md).
*  Or you are ready to [build your-self the network function images](Build-Images.md).
