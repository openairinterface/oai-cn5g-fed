...
In this Section we will use Gnbsim to test our deployemt. Make sure you already have built [Gnbsim docker image](Mini_Deployment.md#6-getting-a-gnbsim-docker-image)<br/>
